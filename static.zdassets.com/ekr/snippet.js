! function(e) {
    ...
    var T = function() {
        ...
        return t = e, (n = [{
            ...
            value: function(e) {
                ...
                var n = Object(j.parseUrlParams)(e.location.href).__zE_ac_version || t;
                if (n) {
                    var r = n.split("/");
    ...
    var K = function(e) {
        function t() {
            return U(this, t), L(this, Q(t).apply(this, arguments))
        }
        var n, r, o;
        return function(e, t) {
    ...
    var H = function(e) {
        function t() {
            return B(this, t), V(this, Z(t).apply(this, arguments))
        }
        var n, r, o;
        return function(e, t) {
            if ("function" != typeof t && null !== t) throw new TypeError("Super expression must either be null or a function");
    ...
    function oe(e) {
        ...
        try {
            ...
            t.getKey().then((function(e) {
                ...
                if (e && e.length) return y.all(n.loadProducts(n.getProductLoaders(e), !1))
            })).catch((function(e) {
                return oe(e)
            }))
        } catch (e) {
